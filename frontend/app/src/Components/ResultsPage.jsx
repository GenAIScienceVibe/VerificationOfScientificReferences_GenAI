      ...
      <div style={{ display: "flex", gap: "24px", maxWidth: "1200px", margin: "0 auto" }}>
        ...
        <div style={{ width: "280px", flexShrink: 0, display: "flex", flexDirection: "column", gap: "16px" }}>
          ...
          <div className="verifai-sidebar-card" style={{ background: "white", borderRadius: "12px", padding: "24px", border: "1px solid #e0e0e0", textAlign: "center" }}>
            <div style={{ position: "relative", display: "flex", justifyContent: "center", alignItems: "center", gap: "6px", marginBottom: "16px", cursor: "default" }}
              onMouseEnter={e => e.currentTarget.querySelector('.cred-tip').style.opacity = '1'}
              onMouseLeave={e => e.currentTarget.querySelector('.cred-tip').style.opacity = '0'}>
              ...
              {filteredClaims.length === 0 ? (
                ...
                <div style={{ display: "flex", flexDirection: "column", gap: "16px" }}>
                  {filteredClaims.map(claim => {
                    const config = statusConfig[claim.status] || statusConfig.insufficient

...
class ErrorCode(StrEnum):
    ...
    # BE-12 report generation and feedback errors.
    REPORT_NOT_FOUND = "REPORT_NOT_FOUND"
    VERIFICATION_NOT_COMPLETED = "VERIFICATION_NOT_COMPLETED"
    REPORT_GENERATION_FAILED = "REPORT_GENERATION_FAILED"
    REPORT_EXPORT_FAILED = "REPORT_EXPORT_FAILED"
    REPORT_EXPORT_NOT_SUPPORTED = "REPORT_EXPORT_NOT_SUPPORTED"
    FEEDBACK_SUBMISSION_FAILED = "FEEDBACK_SUBMISSION_FAILED"
    UAT_SURVEY_VALIDATION_FAILED = "UAT_SURVEY_VALIDATION_FAILED"
    INVALID_RATING = "INVALID_RATING"
    INVALID_FEEDBACK_LABEL = "INVALID_FEEDBACK_LABEL"
